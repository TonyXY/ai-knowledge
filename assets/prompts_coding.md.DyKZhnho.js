import{_ as p,O as l,H as e,f as t,b as a,j as n,k as h,i as o}from"./chunks/framework.Pt2pSV98.js";const F=JSON.parse('{"title":"编程类模板","description":"代码生成、Debug 排查、代码重构——三个高频编程场景的 Prompt 模板","frontmatter":{"title":"编程类模板","description":"代码生成、Debug 排查、代码重构——三个高频编程场景的 Prompt 模板","difficulty":"intermediate"},"headers":[],"relativePath":"prompts/coding.md","filePath":"prompts/coding.md"}'),k={name:"prompts/coding.md"},r={id:"编程类模板",tabindex:"-1"};function d(c,s,g,E,u,b){const i=l("DifficultyBadge");return e(),t("div",null,[a("h1",r,[s[0]||(s[0]=n("编程类模板 ",-1)),h(i,{level:"intermediate"}),s[1]||(s[1]=n()),s[2]||(s[2]=a("a",{class:"header-anchor",href:"#编程类模板","aria-label":'Permalink to "编程类模板 <DifficultyBadge level="intermediate" />"'},"​",-1))]),s[3]||(s[3]=o(`<p>以下三个编程场景的 Prompt 模板，让你的 AI 编程效率翻倍。</p><hr><h2 id="模板一-代码生成" tabindex="-1">模板一：代码生成 <a class="header-anchor" href="#模板一-代码生成" aria-label="Permalink to &quot;模板一：代码生成&quot;">​</a></h2><p><strong>场景说明</strong>：让 AI 根据需求描述生成代码，适用于快速原型、工具函数、配置脚本等。</p><div class="language-markdown vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">markdown</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-light-font-weight:bold;--shiki-dark:#79B8FF;--shiki-dark-font-weight:bold;"># 角色</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#005CC5;--shiki-light-font-weight:bold;--shiki-dark:#79B8FF;--shiki-dark-font-weight:bold;"># 错误信息</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">\`\`\`text</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">[粘贴完整的错误堆栈或日志]</span></span></code></pre></div><h1 id="相关代码" tabindex="-1">相关代码 <a class="header-anchor" href="#相关代码" aria-label="Permalink to &quot;相关代码&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>[粘贴出问题的代码片段，尽可能提供上下文]</span></span></code></pre></div><h1 id="环境信息-可选" tabindex="-1">环境信息（可选） <a class="header-anchor" href="#环境信息-可选" aria-label="Permalink to &quot;环境信息（可选）&quot;">​</a></h1><ul><li>语言版本：[如 Python 3.11]</li><li>框架版本：[如 React 18.2]</li><li>操作系统：[如 macOS 14]</li></ul><h1 id="输出要求" tabindex="-1">输出要求 <a class="header-anchor" href="#输出要求" aria-label="Permalink to &quot;输出要求&quot;">​</a></h1><ol><li><strong>根因分析</strong>：错误的最可能原因（1-2 句话）</li><li><strong>修复方案</strong>：给出修改后的代码</li><li><strong>预防建议</strong>：如何避免类似问题</li><li>如果信息不足无法判断，说明还需要什么信息</li></ol><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span></span></span>
...
<span class="line"><span>- [结构化提示词](./structured-prompt) — 把编程需求组织成结构化 Prompt</span></span></code></pre></div>`,24))])}const m=p(k,[["render",d]]);export{F as __pageData,m as default};
