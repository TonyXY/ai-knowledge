...
<span class="line"><span>- [边界条件二]</span></span></code></pre></div><hr><h2 id="实战示例-代码审查助手" tabindex="-1">实战示例：代码审查助手 <a class="header-anchor" href="#实战示例-代码审查助手" aria-label="Permalink to &quot;实战示例：代码审查助手&quot;">​</a></h2><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>你是一位资深代码评审员，拥有 10 年全栈开发经验，精通 TypeScript、React 和 Node.js。</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>- 问题描述 | 位置 | 修改建议（附代码）</span></span>
<span class="line"><span></span></span>
<span class="line"><span>如果代码没有明显问题，只回复一句：&quot;✅ LGTM，未发现严重问题。&quot;</span></span></code></pre></div><hr><h2 id="实战示例-内容创作助手" tabindex="-1">实战示例：内容创作助手 <a class="header-anchor" href="#实战示例-内容创作助手" aria-label="Permalink to &quot;实战示例：内容创作助手&quot;">​</a></h2><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>你是一位小红书内容运营专家，擅长撰写高互动率的种草文案。</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>拒绝场景：如果用户要求撰写医疗健康建议或金融投资建议，回复&quot;抱歉，这类内容我无法提供。&quot;</span></span></code></pre></div><hr><h2 id="设计原则总结" tabindex="-1">设计原则总结 <a class="header-anchor" href="#设计原则总结" aria-label="Permalink to &quot;设计原则总结&quot;">​</a></h2><ol><li><strong>角色要具体</strong> — 不要说&quot;你是一个助手&quot;，要说&quot;你是一个精通 Vue 3 的前端架构师&quot;</li><li><strong>规则要可执行</strong> — 每一条规则 AI 都能明确判断是否遵循</li><li><strong>约束要量化</strong> — &quot;200-300 字&quot;好于&quot;不要太长&quot;</li><li><strong>边界要清晰</strong> — 明确告诉 AI 什么时候该拒绝</li></ol><hr><h2 id="进阶阅读" tabindex="-1">进阶阅读 <a class="header-anchor" href="#进阶阅读" aria-label="Permalink to &quot;进阶阅读&quot;">​</a></h2><ul><li><a href="./role-prompting.html">角色设定</a> — System Prompt 中角色部分的设计技巧</li><li><a href="./structured-prompt.html">结构化提示词</a> — 用结构化格式组织 System Prompt</li></ul>`,21))])}const P=p(d,[["render",u]]);export{f as __pageData,P as default};
