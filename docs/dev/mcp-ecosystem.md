...
| 仓库 | ⭐ Stars | 技能数 | 推荐理由 | GitHub | 安装方式 |
|------|---------|--------|---------|--------|---------|
| **obra/superpowers** | 161K | 14+ 个 | 完整的软件开发方法论，含 TDD、系统调试、代码审查、并行 Agent 开发 | [链接](https://github.com/obra/superpowers) | `curl -fsSL .../install.sh \| bash` |
| **affaan-m/everything-claude-code** | 182K | 183 个 | 最全技能库——48 Agent、183 技能，跨 Claude/Cursor/OpenCode | [链接](https://github.com/affaan-m/everything-claude-code) | `git clone && ./install.sh` |
| **addyosmani/agent-skills** | 44K | 23 个 | Google 工程文化，生产级工程技能 | [链接](https://github.com/addyosmani/agent-skills) | `gemini skills install ./agent-skills/skills/` |
| **davila7/claude-code-templates** | 27K | 100+ 个 | 即装即用的 Agent/命令/MCP 合集 | [链接](https://github.com/davila7/claude-code-templates) | `npx claude-code-templates@latest --agent <name>` |
| **alirezarezvani/claude-skills** | 15K | 313+ 个 | 跨 12 个工具，覆盖工程/营销/产品/金融 | [链接](https://github.com/AlirezaRezvani/claude-skills) | `git clone && ./scripts/install.sh --tool <tool>` |
