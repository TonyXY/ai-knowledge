...
| 仓库 | ⭐ Stars | 技能数 | 推荐理由 | 地址 |
|------|---------|--------|---------|------|
| **obra/superpowers** | 161K | 14+ 个 | 完整的软件开发方法论，含 TDD、系统调试、代码审查、并行 Agent 开发 | `https://github.com/obra/superpowers` |
| **affaan-m/everything-claude-code** | 182K | 183 个 | 最全技能库——48 Agent、183 技能，跨 Claude/Cursor/OpenCode | `https://github.com/affaan-m/everything-claude-code` |
| **addyosmani/agent-skills** | 44K | 23 个 | Google 工程文化，生产级工程技能 | `https://github.com/addyosmani/agent-skills` |
| **davila7/claude-code-templates** | 27K | 100+ 个 | 即装即用的 Agent/命令/MCP 合集 | `https://github.com/davila7/claude-code-templates` |
| **alirezarezvani/claude-skills** | 15K | 313+ 个 | 跨 12 个工具，覆盖工程/营销/产品/金融 | `https://github.com/AlirezaRezvani/claude-skills` |
...
| 仓库 | ⭐ Stars | 说明 | 地址 |
|------|---------|------|------|
| **anthropics/claude-code** | 125K | Claude Code 官方仓库，内置 CLI、GitHub Action 和参考插件实现 | `https://github.com/anthropics/claude-code` |
